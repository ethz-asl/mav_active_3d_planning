...
inline const ::mav_msgs::EigenTrajectoryPointVector& planningMsgToMavMsg(const EigenTrajectoryPointVector &planningTraj){
...
inline const EigenTrajectoryPointVector & mavMsgToPlanningMsg(const ::mav_msgs::EigenTrajectoryPointVector &mavTraj){
