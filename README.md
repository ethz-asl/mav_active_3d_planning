...
**Tips and notes**
* [Example](#Example)
* [Building UE4 worlds](#Building UE4 worlds)
...
* Make sure the unrealcv plugin is installed __and__ activated in the current project (Edit > Plugins > Science > Unreal CV, [unrealcv docs](http://docs.unrealcv.org/en/master/plugin/install.html)).
* Set the player to spectator (World Settings > Game Mode > Selected GameMode > Default Pawn Class := SpectatorPawn).
