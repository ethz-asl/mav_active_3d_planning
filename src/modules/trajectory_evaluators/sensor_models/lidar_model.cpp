...
namespace mav_active_3d_planning {
    namespace sensor_models {
        ...
        bool LidarModel::getVisibleVoxelsFromTrajectory(std::vector <Eigen::Vector3d> *result,
        ...
        void LidarModel::sampleViewpoints(std::vector<int> *result, const TrajectorySegment &traj_in) {
        ...
        void LidarModel::visualizeSensorView(visualization_msgs::MarkerArray *msg, const TrajectorySegment &traj_in) {
            std::vector<int> indices;
            sampleViewpoints(&indices, traj_in);
        ...
        void LidarModel::visualizeSingleView(visualization_msgs::MarkerArray *msg, const Eigen::Vector3d &position,
