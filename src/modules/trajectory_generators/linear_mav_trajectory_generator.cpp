...
//        parameters_.inequality_constraint_tolerance = 0.1;
    ...
    bool LinearMavTrajectoryGeneration::simulateTrajectory(const mav_msgs::EigenTrajectoryPoint &start, const mav_msgs::EigenTrajectoryPoint &goal,
                            mav_msgs::EigenTrajectoryPointVector *result) {
        // Build trajectory
        ...
        while (current_yaw != goal_yaw || current_pos != goal.position_W) {
            ...
            if (current_pos != goal.position_W) {
                ...
                } else if ((current_pos - goal.position_W).norm() > v_curr * v_curr / 2.0 / a_max_) {
                    // Accelerate
