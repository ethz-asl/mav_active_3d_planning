#include "active_3d_planning/module/trajectory_generator/segment_selector/random_restricted.h"
...
RandomRestricted::RandomRestricted(PlannerI &planner) : SegmentSelector(planner) {}
