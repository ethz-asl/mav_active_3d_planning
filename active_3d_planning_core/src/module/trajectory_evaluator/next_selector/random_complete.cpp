#include "active_3d_planning/module/trajectory_evaluator/next_selector/random_complete.h"
...
std::vector<TrajectorySegment* > RandomComplete::getFromSingle(TrajectorySegment *traj_in) {
