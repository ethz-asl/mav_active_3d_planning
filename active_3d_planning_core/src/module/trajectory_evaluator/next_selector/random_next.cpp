#include "active_3d_planning/module/trajectory_evaluator/next_selector/random_next.h"
...
// RandomNext
ModuleFactoryRegistry::Registration<RandomNext>
    RandomNext::registration("RandomNext");
