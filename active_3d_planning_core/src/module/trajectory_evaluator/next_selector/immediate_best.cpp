#include "active_3d_planning/module/trajectory_evaluator/next_selector/immediate_best.h"
...
// ImmediateBest
ModuleFactoryRegistry::Registration<ImmediateBest>
    ImmediateBest::registration("ImmediateBest");
