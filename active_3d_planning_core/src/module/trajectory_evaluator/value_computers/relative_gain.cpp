#include "active_3d_planning/module/trajectory_evaluator/value_computer/relative_gain.h"
...
// RelativeGain
        ModuleFactoryRegistry::Registration<RelativeGain>
                RelativeGain::registration("RelativeGain");
