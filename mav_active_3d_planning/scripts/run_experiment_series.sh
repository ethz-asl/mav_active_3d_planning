...
# *** Args (need to be set) ***
n_experiments=12
target_dir="/home/lukas/Documents/MT/Data/series_nbvp"		# Can reuse same dir to add experiments
clear_voxblox_maps=true		# Irreversibly remove maps after evaluation to save disk space
visualize=false		# Publish and record visualization (save diskspace and computation time)
